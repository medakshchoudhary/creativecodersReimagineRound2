...
function Tagline1() {
    return (
        <div className="Tagline1-banner w-full bg-[url('/images/weonair.jpg')] bg-cover bg-center flex items-center justify-center">
            <h1 className="tagline text-white text-[12vw] flex gap-10">
                <span>
                    <span className="span">W</span><span className="span">E</span>
                </span>
                <span>

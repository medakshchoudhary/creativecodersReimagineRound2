...
function LastTagline() {
  ...
  return (
    <div className="taglinelast w-full h-[100vh] relative overflow-hidden bg-black flex items-center justify-center">
        <img className="colon1 w-16 absolute top-[20%] left-[10%]" src="/svgs/quote-left.svg" alt="" />
        ...
        <img className="colon2 w-16 absolute bottom-[20%] right-[5%]" src="/svgs/quote-right.svg" alt="" />
    </div>
  )
}
